import{s as r,d as i,N as b,j as t,u as f,r as j,a as w,b as v,c as d,e as y,f as D}from"./index-CJO0Qxxs.js";import{P as $}from"./PageTitle-LCPlhtKT.js";import{s as M}from"./selectors-3DDbZiSm.js";import{S as a,D as s}from"./DrinksPage.styled-3SVCy2Kd.js";import"./react-select.esm-n6Y28yhf.js";const S=r.section`
  margin-bottom: 112px;
...
`,E=()=>{var h,l,c,g;const x=w(),n=v(M),u=d.useMediaQuery({query:"(min-width: 1440px)"}),p=d.useMediaQuery({query:"(min-width: 768px) and (max-width: 1439px)"}),k=d.useMediaQuery({query:"(max-width: 767px)"}),m=u?3:p?2:1;return y.useEffect(()=>{x(D({limit:m}))},[x,k,p,m]),t.jsx(t.Fragment,{children:t.jsxs("section",{children:[t.jsx(o,{children:"Ordinary Drink"}),t.jsx(a,{children:(h=n["Ordinary Drink"])==null?void 0:h.map(e=>t.jsx(s,{drink:e},e._id))}),t.jsx(o,{children:"Cocktail"}),t.jsx(a,{children:(l=n.Cocktail)==null?void 0:l.map(e=>t.jsx(s,{drink:e},e._id))}),t.jsx(o,{children:"Shake"}),t.jsx(a,{children:(c=n.Shake)==null?void 0:c.map(e=>t.jsx(s,{drink:e},e._id))}),t.jsx(o,{children:"Other/Unknow"}),t.jsx(a,{children:(g=n["Other/Unknown"])==null?void 0:g.map(e=>t.jsx(s,{drink:e},e._id))}),t.jsx(A,{to:"/drinks",children:"Other drinks"})]})})},L=()=>t.jsxs(t.Fragment,{children:[t.jsx(T,{}),t.jsx(E,{})]});export{L as default};
