import{s as i,d as e,P as c,a as g,e as l,h as u,b as h,j as t,M as w,K as $,O as j,S as v,T as y}from"./index-zqTu2PMS.js";import{b as T,g as S,f as D}from"./selectors-3DDbZiSm.js";const z=i.div`
  margin-bottom: 18px;
...
`,b=({ingredientsArray:s})=>{const o=g();l.useEffect(()=>{o(u())},[o]);const n=h(T),r=window.innerWidth<768,p=window.innerWidth>=768&&window.innerWidth<1440,x=d=>{if(n.length!==0)return n==null?void 0:n.find(a=>d===a.title)[r?"thumbSmall":p?"thumbMedium":"ingredientThumb"]};return t.jsxs("div",{children:[t.jsx(A,{children:"Ingredients"}),t.jsx(M,{children:s==null?void 0:s.map(({title:d,measure:a})=>t.jsxs(W,{children:[t.jsx(B,{children:t.jsx(H,{src:x(d),alt:d})}),t.jsxs(L,{children:[t.jsx(m,{children:d}),t.jsx(O,{children:a})]})]},d))})]})};b.propTypes={ingredientsArray:c.array};const C="/project-drink-master/assets/three-cocktails-mobile@1x-Db068_xD.jpg",J="/project-drink-master/assets/three-cocktails@1x-TzhNJt-O.jpg",K=i.div`
  display: flex;
