import{g as pe,Z as ie,u as Q,d as K,$ as he,a0 as ve,W as Pe,a as se,l as oe,P as k,j as W,o as xe,e as ye,b as Ce,m as ke,a1 as Le}from"./index-ivwcUfbZ.js";import{c as Ne}from"./selectors-qDc_-Qs5.js";const De=({mobile:d,tablet:X,desktop:F,default:O})=>{const[_,b]=pe.useState($());pe.useEffect(()=>{const f=()=>{const a=window.innerWidth;a<parseInt(ie.tablet)?b("mobileM"):a<parseInt(ie.desktop)?b("tablet"):b("desktop")};return f(),window.addEventListener("resize",f),()=>{window.removeEventListener("resize",f)}},[]);function $(){const f=window.innerWidth;return f<parseInt(ie.tablet)?"mobileM":f<parseInt(ie.desktop)?"tablet":"desktop"}return(()=>{switch(_){case"mobileM":return d||9;case"tablet":return X||8;case"desktop":return F||9;default:return O||9}})()},Se=Q.div`
  display: flex;
