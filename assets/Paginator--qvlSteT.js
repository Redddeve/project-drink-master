import{g as pe,a1 as ie,u as Q,d as F,a2 as he,a3 as ve,X as Pe,a as se,l as oe,P as k,j as W,p as xe,e as ye,b as Ce,n as ke,a4 as Le}from"./index-AhimbL1e.js";import{c as Ne}from"./selectors-Ppdwvh5x.js";const De=({mobile:d,tablet:X,desktop:J,default:O})=>{const[_,b]=pe.useState($());pe.useEffect(()=>{const f=()=>{const a=window.innerWidth;a<parseInt(ie.tablet)?b("mobileM"):a<parseInt(ie.desktop)?b("tablet"):b("desktop")};return f(),window.addEventListener("resize",f),()=>{window.removeEventListener("resize",f)}},[]);function $(){const f=window.innerWidth;return f<parseInt(ie.tablet)?"mobileM":f<parseInt(ie.desktop)?"tablet":"desktop"}return(()=>{switch(_){case"mobileM":return d||9;case"tablet":return X||8;case"desktop":return J||9;default:return O||9}})()},Se=Q.div`
  display: flex;
