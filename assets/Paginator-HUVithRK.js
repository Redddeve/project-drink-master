import{g as pe,Z as ie,u as Q,d as K,$ as he,a0 as ve,W as Pe,a as se,l as oe,P as k,j as W,o as xe,e as ye,b as Ce,m as ke,a1 as Le}from"./index-JNQRRAzc.js";import{c as Ne}from"./selectors-p8WfivJo.js";const De=({mobile:h,tablet:X,desktop:F,default:O})=>{const[_,m]=pe.useState($());pe.useEffect(()=>{const d=()=>{const a=window.innerWidth;a<parseInt(ie.tablet)?m("mobileM"):a<parseInt(ie.desktop)?m("tablet"):m("desktop")};return d(),window.addEventListener("resize",d),()=>{window.removeEventListener("resize",d)}},[]);function $(){const d=window.innerWidth;return d<parseInt(ie.tablet)?"mobileM":d<parseInt(ie.desktop)?"tablet":"desktop"}return(()=>{switch(_){case"mobileM":return h||9;case"tablet":return X||8;case"desktop":return F||9;default:return O||9}})()},Se=Q.div`
  display: flex;
